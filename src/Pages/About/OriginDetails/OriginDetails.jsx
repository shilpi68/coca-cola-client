    ...
    return (
        <div >
            ...
            data-aos-duration="1000"
             className="hero min-h-screen" style={{backgroundImage:`url('${OrginImg}')`}}>
       </div>
            <h2 className="mb-10 font-bold text-2xl text-center"
            data-aos="fade-down" 
            data-aos-easing="linear"
            data-aos-duration="1000">Our History</h2>
            ...
            data-aos-duration="1000">
              ...
              data-aos-easing="linear"
              data-aos-duration="1000">The Birth of a Refreshing Idea</h2>
              <p className='text-3xl font-medium text-center'
              data-aos="fade-up-left" 
              data-aos-easing="linear"
              data-aos-duration="1000"> Coca-Cola History</p>
              <p className='text-xl font-serif mt-6'
              data-aos="fade-up-right" 
              data-aos-easing="linear"
              data-aos-duration="1000">The product that has given the world its best-known taste
                  ...
                  the syrup for Coca‑Cola, and carried a jug of the
                   new product down the street to Jacobs Pharmacy,
                    where it was sampled, pronounced excellent and
                     placed on sale for five cents a glass as a soda
                      ...
                      with the new syrup to produce a drink that was
                       at once Delicious and Refreshing a theme that
                        ...
                        <img className='w-5/12 mx-auto p-8'
                        data-aos="fade-right" 
                        data-aos-easing="linear"
                        data-aos-duration="1000" src={JohnstithImg} alt="" />
                        <p className=' w-5/12 mx-auto mb-6 text-xl font-medium'
                        data-aos="fade-right" 
                        data-aos-easing="linear"
                        data-aos-duration="1000">Dr.John Pemberton</p>
                        <hr />
                        <p className='text-xl font-medium w-11/12 mx-auto mt-6 mb-6'
                        data-aos="fade-up-right" 
                        data-aos-easing="linear"
                        data-aos-duration="1000">Dr. John Stith Pemberton, a local pharmacist, produced the
                      ...
                      <p>
                        ...
                        data-aos="fade-up-left" 
                        data-aos-easing="linear"
                        data-aos-duration="1000">Thinking that the two Cs would look well in advertising,
                     ...
                     data-aos-easing="linear"
                     data-aos-duration="1000"> Dr. Pemberton never realized the potential of the beverage he created.
