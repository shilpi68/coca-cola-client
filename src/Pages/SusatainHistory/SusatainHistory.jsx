...
const SusatainHistory = () => {
    return (
        ...
        ></SectionTitle>
         ...
         className="mt-10 flex hero-content flex-col lg:flex-row">
            ...
            <div><div className="card bg-base-100 w-96 shadow-xl flex-1 ">
                <div className="card-body ">
                    ...
                    <p className="font-medium">Sustainability is not something new at The Coca‑Cola Company.
                         ...
                         <Link to='/susatainDetails'>
                           <button className="btn btn-outline rounded-full btn-block font-bold text-lg">Read more</button>
                           </Link>
                </div>
