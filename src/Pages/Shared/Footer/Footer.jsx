...
const Footer = () => {
            ...
            <div className="text-white flex justify-between hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <button className="btn btn-outline btn-success rounded-full mb-4 flex">
                        <p><MdLocationPin className="text-xl"></MdLocationPin></p>
  ...
  <nav className=" text-white">
    <h6 className="footer-title">Neep Help</h6>
    <a className="link link-hover">FAQ</a>
    <a className="link link-hover">Sitemap</a>
    <a className="link link-hover">contact Us</a>
  </nav>
  <nav className=" text-white">
  <h6 className="footer-title">Terms Sfuse</h6>
    ...
    <div className="grid grid-flow-col gap-4">
      <a>
        <svg
          ...
          height="30"
          viewBox="0 0 24 24"
          className="fill-current text-blue-400 bg-white rounded-full  ">
          <path
      ...
      <a>
        <svg
          ...
          height="30"
          viewBox="0 0 24 24"
          className="fill-current text-sky-400 bg-white rounded-full">
          <path
...
<div className="footer footer-center text-white  p-4">
  <aside>
    <p>© {new Date().getFullYear()}The coca-cola company. All right reserved. </p>
  </aside>
</div>
        </div>
    );
